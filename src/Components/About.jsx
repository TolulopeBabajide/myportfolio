...
const About = () => {
  ...
  Fullstack Software Developer
            ...
            <div className='p-4 m-4 text-white bg-slate-900'>
                ...
                <p>];<br /> <span className='text-blue-500'>if</span> (have_a_project) <span className='text-blue-500'>navigate</span><span className='text-red-300'>('/contact)</span><span className='animate__animated animate__flash animate__infinite animate__slow'>|</span></p> 
             </div>
        </div>
